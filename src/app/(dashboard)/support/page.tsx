...
const INITIAL_TICKETS: Ticket[] = [
  ...
  },
  {
    ...
    subject: "Demande d'activation du module Assistant Etarcos IA",
              ...
              <div className="space-y-2 max-h-[500px] overflow-y-auto pr-1">
                {tickets.map((t) => (
                  <button
                    ...
                    className={`w-full text-left p-3 rounded-xl border transition-all flex flex-col gap-1.5 ${selectedTicket?.id === t.id
                  ...
                  >
                    ...
                    <div className="flex gap-1.5 items-center mt-1">
                      <Badge className={`text-[9px] px-1.5 py-0 border ${t.status === "open"
